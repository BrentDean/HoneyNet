...
- Deployed and operated an Internet-facing **T-Pot honeynet** on a VPS.
- Analyzed **Cowrie** and **Suricata** telemetry offline after collection.
- Examined credential attacks across **1,137 fake successful Cowrie logins** from **508 unique source IPs**.
- Investigated automated post-login behavior including host discovery, persistence attempts, credential changes, and process/cron inspection.
- Compared activity across SSH, SMB, IEC-104/SCADA, SNMP, Elasticsearch/OpenSearch, ADB, MQTT, and other exposed services.
- Kept raw operational data out of the public report while preserving reproducible aggregate evidence and analysis.
...
- Hostname: `honeynet2`
- Public VPS: Hetzner Cloud VPS (public address redacted)
